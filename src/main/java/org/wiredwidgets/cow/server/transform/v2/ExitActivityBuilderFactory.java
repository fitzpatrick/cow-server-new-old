...
public class ExitActivityBuilderFactory extends ActivityBuilderFactory<Exit> {
    ...
    public ExitActivityBuilderFactory() {
        super(Exit.class, null);
    }

    @Override
    public ExitActivityBuilder createActivityBuilder(ProcessContext context, Exit activity) {
        return new ExitActivityBuilder(context, activity, this);
    }
