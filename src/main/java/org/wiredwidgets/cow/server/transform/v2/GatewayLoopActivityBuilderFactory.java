...
public class GatewayLoopActivityBuilderFactory extends ActivityBuilderFactory<Loop> {
    ...
    public GatewayLoopActivityBuilderFactory() {
        super(Loop.class, Bpmn20ProcessContext.class);
    }

    @Override
    public ActivityBuilder createActivityBuilder(ProcessContext context, Loop loop) {
        return new GatewayLoopActivityBuilder(context, loop, this);
    }
